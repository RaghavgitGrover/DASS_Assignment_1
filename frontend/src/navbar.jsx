    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
            <div className="container-fluid">
                <NavLink className="navbar-brand" to="/"> Rolx </NavLink>
                    ...
                    <ul className="navbar-nav ms-auto">
                        ...
                        {currentUser && (
                            <>
                                ...
                                <li> <NavLink className="nav-link" to="/sell"> Sell </NavLink> </li>
                                <li className="nav-item"> <NavLink className="nav-link" to="/orders"> Orders </NavLink> </li>
                                <li className="nav-item"> <NavLink className="nav-link" to="/delivery"> Delivery </NavLink> </li>
                                <li className="nav-item"> <NavLink className="nav-link" to="/support"> Support </NavLink> </li>
                                <li> <button className="btn btn-danger" onClick={handleLogout} style={{ padding: '4px', marginTop: '4px' }}> Logout </button> </li>
                            </>
                        )}
                    </ul>
                </div>
